...
var pause, sound, pausemenu, pauseimg, pausemenuimg, soundimg
function preload() {
  //load all the images
  pauseimg = loadImage("game img/system UI/Pause.png")
  pausemenuimg = loadImage("game img/system UI/pause menu.png")
  soundimg = loadImage("game img/system UI/Sound.png")
...
function setup() {
  ...
  pause = createSprite(100, 50);
  pausemenu = createSprite(displayWidth / 2, displayHeight / 2)
  ...
  pausemenu.addImage("pause", pausemenuimg)
  pause.scale = 0.25
  pausemenu.visible = false;
  pausemenu.scale = 2.5
  pausemenu.depth = mfb.depth
  pausemenu.depth += 1
}
